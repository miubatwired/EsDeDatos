        ...
        do {
            ...
            switch (opcion){
                case 1:
                    ...
                    lis.insertaInicio(new NodoDos(d1,d2));
                    break;
                case 2:
                    d1 = JOptionPane.showInputDialog("Dato String del nodo");
                    d2 = Float.parseFloat(JOptionPane.showInputDialog("Dato Float del nodo"));
                    lis.insertarFinal(new NodoDos(d1,d2));
                    break;
                case 3:
                    JOptionPane.showMessageDialog(null, lis.toString());
                    break;
                case 4:
                    JOptionPane.showMessageDialog(null, "Suma de datos 2:  " + lis.sumaDatos2());
                    break;
                case 5:
                    lis.eliminaInicio();
                    break;
